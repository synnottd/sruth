...
-- CreateEnum
CREATE TYPE "SessionStatus" AS ENUM ('STARTING', 'LIVE', 'ERROR', 'STOPPED');
...
-- AddForeignKey
ALTER TABLE "OutputSession" ADD CONSTRAINT "OutputSession_sessionId_fkey" FOREIGN KEY ("sessionId") REFERENCES "StreamSession"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "OutputSession" ADD CONSTRAINT "OutputSession_outputId_fkey" FOREIGN KEY ("outputId") REFERENCES "Output"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
